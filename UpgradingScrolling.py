################################################
# File Name: UpgradingScrolling.py
# Creator Name: Mr. Acosta
# Date Created: 2-26-2020
# Date Modified: 2-26-2020
#################################################
#
#################################################
...
width = 800
height = 600
# We can replace the "0, 32" from previous programs with pygame.FULLSCREEN or pygame.RESIZABLE
...
# Start the game by setting running to True
running = not pauseGame()
...
# save scores to display on the title screen
if score > highScore:
    f = open("scores.txt", "w")
    f.write(str(score))
    f.close()
